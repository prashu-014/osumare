...
const Service = () => {
  ...
  return (
    <section className="min-h-svh md:min-h-screen bg-slate-100 py-10 px-4 flex justify-center items-center flex-col gap-10">
      <div className="text-center flex flex-col gap-3">
        <h1 className=" text-2xl md:text-4xl font-bold">Our Service Offering</h1>
